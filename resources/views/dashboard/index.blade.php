                ...
                <div class="card-body">                
                  <div class="row gy-4">
                    <div class="col-sm-7 order-1 order-sm-0">
                      ...
                      <p class="fs-6">Congratulations! Your account has been Setup and  you are ready to configure your dashboard now.Configuration only take a couple of seconds.</p><a class="btn btn-primary btn-sm mt-3" href="#!">Upgrad Plan</a>
                    </div>
                    <div class="col-sm-5"><img class="img-fluid" src="assets/images/dashboard/welcome-banner.png" alt="welcome banner"></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="assets/images/avtar/6.jpg" alt="recent-product"></div>
                    ...
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="assets/images/avtar/2.jpg" alt="recent-product"></div>
                    ...
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="assets/images/avtar/3.jpg" alt="recent-product"></div>
                    ...
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="assets/images/avtar/4.jpg" alt="recent-product"></div>
                    ...
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="assets/images/avtar/5.jpg" alt="recent-product"></div>
          ...
          <div class="card dash-chat">
            ...
            <div class="card-body"> 
              <div class="dash-chatbox">
                <ul class="chating-list" data-simplebar>
                  <li>
                    <div class="user-msgbox">
                      <div class="media"><img class="img-fluid" src="assets/images/avtar/1.jpg" alt="image">
                  ...
                  <li>
                    <div class="admin-msgbox">
                      <div class="media">
                        ...
                        </div><img class="img-fluid" src="assets/images/avtar/2.jpg" alt="image">
                      </div>
                    </div>
                  </li>
                  <li>
                ...
                <div class="userchat-typebox d-flex"><a class="btn btn-primary me-2" href="#!"><i data-feather="smile"></i></a>
                  <input class="form-control" type="text" placeholder="Type a message" value="" autocomplete="off"><a class="btn btn-primary ms-2" href="#!"> <i data-feather="send">  </i></a>
                </div>
              </div>
            </div>
          </div>
