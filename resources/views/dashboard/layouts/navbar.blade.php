        ...
        <ul class="nav-iconlist">  
          ...
          <li class="nav-profile">
            ...
            <div class="hover-dropdown navprofile-drop">
              <ul>
                <li><a href="profile.html"><i class="me-2 align-middle" data-feather="user"></i>profile</a></li>
                <li><a href="email-inbox.html"><i class="me-2 align-middle" data-feather="mail"></i>inbox</a></li>
                <li><a href="user-edit.html"><i class="me-2 align-middle" data-feather="settings"></i>setting</a></li>
                <li><a href="login.html"><i class="me-2 align-middle" data-feather="log-out"></i>log out</a></li>
              </ul>
            </div>
          </li>
        </ul>
